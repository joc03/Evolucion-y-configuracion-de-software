                ...
                <table class="table table-borderless " style="background: black; margin: 0; border: 0" id="dataTableDatosBasicos" width="100%" cellspacing="0">
                    ...
                    <tbody style="color: white">
                        <tr>
                            ...
                            %>
                            <td><input class="form-control bg-light"  name="txtcodigoMaqui" type="text"
                                       readonly=""
                                       value="<%=codigo%>"
                                       ></td>
                        </tr>
                        <tr>
                            ...
                            <td><input class="form-control bg-light"  name="txtplacaVe" 
                        ...
                        <tr>
                            ...
                            <td><input class="form-control"  name="txtPoliVe" 
                                       style="text-transform: uppercase"
                                       type="text" ></td>
                        </tr>                                    
                        <tr>
                            ...
                            <td><input class="form-control" name="txtpesTaraVe"  type="text" ></td>
                        </tr>
                        <tr>
                            <th scope="row">PESO BRUTO (T)</th>
                            <td><input class="form-control" name="txtPesoBruVe"  type="text" ></td>
                        </tr>
                        <tr>
                            <th scope="row">CARGO UNITARIO</th>
                            <td><input class="form-control" name="txtcargoUniVe"  type="text" ></td>
                        </tr>
                    </tbody>
                </table>
            </div>
