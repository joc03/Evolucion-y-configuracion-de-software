    ...
    <body>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="container-fluid" style="border-style: solid; padding: 20px; border-color: #cccccc">
                    <div class="row">
                            ...
                            <div class="col-7 " >
                                <input type="date" id="FechaTransporte" class="form-control">
                            </div>
                        </div>
                    <br>                    
                    <div class="row">
                            ...
                            <div class="col-7 " >
                                ...
                                <select name="" id="SoliChofer" class="form-control" >
                                     <% 
            ...
            <div class="card-footer">
                <button class="btn btn-primary" onclick="" >Generar Solicitud</button>
            </div>
        </div>
