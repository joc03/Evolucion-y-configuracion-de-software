			...
			<!--sidebar start-->
					...
					<li class="item">
						...
						<a href="#personal" class="menu-btn">
							<i class="fas fa-user-circle"></i><span>Personal<i class="fas fa-chevron-down drop-down"></i></span>
						</a>
						<div class="sub-menu">
							<a href="#"><i class="fas fa-image"></i><span>Registrar personal</span></a>
							<a href="#"><i class="fas fa-address-card"></i><span>Listar personal</span></a>
						</div>
					</li> -->
					...
					<li class="item" id="vehículos">
						...
						<a href="#Servicios" class="menu-btn">
                                                    <i class="fas fa-sticky-note"></i><span>Servicios <i class="fas fa-chevron-down drop-down"></i></span>
						</a>
						<div class="sub-menu">
